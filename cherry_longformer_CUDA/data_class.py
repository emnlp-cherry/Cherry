...
class CustomDataset(Dataset):
    ...
    def __init__(self,data_frame, with_labels, pretrained_model, maxlen, global_attention_location,padding_strategy):
    ...
    def __getitem__(self, index):
        ...
        encoded_pair = self.tokenizer(fact, context,
                                      ...
                                      truncation= "only_second" , #'only_second', #True,  # Truncate to max_length and truncates the context only
        ...
        if self.with_labels:  # True if the dataset has labels
            ...
            return token_ids, attn_masks, global_attention_mask, label
        else:
