...
def prepare_data(data_splits, batch_size, pretrained_model,max_seq_len,global_attention_loc,padding_strategy):
    ...
    for data_split in data_splits:
        ...
        train_set = CustomDataset(df_train, with_labels=True, pretrained_model=pretrained_model,maxlen=max_seq_len,global_attention_location=global_attention_loc,padding_strategy = padding_strategy)
        test_set = CustomDataset(df_test, with_labels=True, pretrained_model=pretrained_model,maxlen=max_seq_len,global_attention_location=global_attention_loc,padding_strategy = padding_strategy)
